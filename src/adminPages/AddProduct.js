            ...
            <div className="">
              <div className="mb-10 my-5">
                ...
                {/* <input
                  ...
                  className="shadow appearance-none border-2 rounded w-full py-2 px-3 border-amber-900 bg-orange-100 leading-tight focus:outline-none focus:shadow-outline"
                /> */}
                <textarea className="my-3 border-2 rounded resize-none w-full h-full py-2 px-3 border-amber-900 bg-orange-100 " placeholder="Description Product" name="desc" onChange={handleChange}></textarea>

                <label className="w-40 text-slate-400 font-semibold flex shadow border-2 rounded py-2 px-3 border-amber-900 bg-orange-100">
                  Photo Product
                  <img src="./assets/upload.png" alt="" className="w-4 ml-2" />
                  <input
